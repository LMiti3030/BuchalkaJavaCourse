...
/**
 * Write a method named sumFirstAndLastDigit with one parameter of type int called number. 2
...
public class Exercise17FirstAndLastDigitSum {

    private Exercise17FirstAndLastDigitSum(){}
